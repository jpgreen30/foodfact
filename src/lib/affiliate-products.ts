...
export const AFFILIATE_PRODUCTS: AffiliateProduct[] = [
  // Organic Baby Food
  {
    ...
    affiliateUrl: amazonProduct('B01LWXB7G3'),
  ...
  },
  {
    ...
    affiliateUrl: amazonProduct('B00GMLKP0I'),
    category: 'organic-food',
  ...
  },
  {
    ...
    affiliateUrl: amazonProduct('B00SSNMKQG'),
    category: 'organic-food',
  ...
  // Prenatal Vitamins
  {
    ...
    affiliateUrl: amazonProduct('B003B3OB1W'),
  ...
  },
  {
    ...
    affiliateUrl: amazonProduct('B07T7RNWVB'),
    category: 'prenatal-vitamins',
  ...
  // Postnatal Vitamins
  {
    ...
    affiliateUrl: amazonProduct('B00GGHRJ7C'),
  ...
  },
  {
    ...
    affiliateUrl: amazonProduct('B07MH1SQ6V'),
    category: 'postnatal-vitamins',
  ...
  // Food Makers
  {
    ...
    affiliateUrl: amazonProduct('B084KYDM8C'),
  ...
  },
  {
    ...
    affiliateUrl: amazonProduct('B01MQUDOVP'),
    category: 'food-makers',
  ...
  // Storage
  {
    ...
    affiliateUrl: amazonProduct('B07CWSHTWN'),
    category: 'storage',
  ...
  },
  {
    ...
    affiliateUrl: amazonProduct('B076M5S7WJ'),
    category: 'storage',
  ...
  // Testing Kits
  {
    ...
    affiliateUrl: amazonProduct('B07PFYJ7FP'),
  ...
  // Feeding Gear
  {
    ...
    affiliateUrl: amazonProduct('B00GBFHWC6'),
  ...
  },
  {
    ...
    affiliateUrl: amazonProduct('B00KMYBYYI'),
    category: 'feeding-gear',
  ...
  // Baby Formula
  {
    ...
    affiliateUrl: amazonProduct('B07JKQD3D4'),
  ...
  // NEW: More Prenatal Vitamins
  {
    ...
    affiliateUrl: amazonProduct('B000I11WRG'),
    category: 'prenatal-vitamins',
  ...
  },
  {
    ...
    affiliateUrl: amazonProduct('B01NAF1ZT4'),
    category: 'prenatal-vitamins',
  ...
  // NEW: Water Filter (Heavy Metals)
  {
    ...
    affiliateUrl: amazonProduct('B01LXSQG82'),
    category: 'testing-kits',
  ...
  // NEW: Organic Toddler Snacks
  {
    ...
    affiliateUrl: amazonProduct('B07QKTQYDZ'),
    category: 'organic-food',
  ...
  },
  {
    ...
    affiliateUrl: amazonProduct('B07PFH4WZ1'),
    category: 'organic-food',
  ...
  },
  {
    ...
    affiliateUrl: amazonProduct('B07PKGJFNR'),
    category: 'organic-food',
  ...
  // NEW: BPA-Free Storage Set
  {
    ...
    affiliateUrl: amazonProduct('B07QLPHQVJ'),
    category: 'storage',
  ...
  // NEW: Organic Meal Pouches
  {
    ...
    affiliateUrl: amazonProduct('B07NNFKNWD'),
    category: 'organic-food',
  ...
  // NEW: Postnatal Vitamin
  {
    ...
    affiliateUrl: amazonProduct('B09TXK7K3D'),
    category: 'postnatal-vitamins',
