...
function amazonSearch(keywords: string): string {
...
export const AFFILIATE_PRODUCTS: AffiliateProduct[] = [
  // Organic Baby Food
  {
    ...
    affiliateUrl: amazonSearch('Happy Baby Organics Clearly Crafted Stage 1 baby food pouches'),
  ...
  },
  {
    ...
    affiliateUrl: amazonSearch('Plum Organics Stage 1 baby food variety pack puree'),
    category: 'organic-food',
  ...
  },
  {
    ...
    affiliateUrl: amazonSearch('Gerber Organic 1st Foods baby food pouches stage 1'),
    category: 'organic-food',
  ...
  // Prenatal Vitamins
  {
    ...
    affiliateUrl: amazonSearch('Garden of Life Vitamin Code Raw Prenatal whole food multivitamin'),
  ...
  },
  {
    ...
    affiliateUrl: amazonSearch('Ritual Essential Prenatal Multivitamin DHA folate'),
    category: 'prenatal-vitamins',
  ...
  // Postnatal Vitamins
  {
    ...
    affiliateUrl: amazonSearch('MegaFood Baby and Me 2 Postnatal multivitamin breastfeeding'),
  ...
  },
  {
    ...
    affiliateUrl: amazonSearch('Pink Stork Postnatal Support lactation tea organic'),
    category: 'postnatal-vitamins',
  ...
  // Food Makers
  {
    ...
    affiliateUrl: amazonSearch('BEABA Babycook Neo baby food maker steam blend BPA free'),
  ...
  },
  {
    ...
    affiliateUrl: amazonSearch('NutriBullet Baby complete food making system blender'),
    category: 'food-makers',
  ...
  // Storage
  {
    ...
    affiliateUrl: amazonSearch('WeeSprout glass baby food storage jars BPA free'),
    category: 'storage',
  ...
  },
  {
    ...
    affiliateUrl: amazonSearch('Infantino Squeeze Station reusable baby food pouches'),
    category: 'storage',
  ...
  // Testing Kits
  {
    ...
    affiliateUrl: amazonSearch('heavy metals test kit baby food lead arsenic cadmium mercury'),
  ...
  // Feeding Gear
  {
    ...
    affiliateUrl: amazonSearch('Boon PULP silicone feeder baby BPA free'),
  ...
  },
  {
    ...
    affiliateUrl: amazonSearch('NumNum Pre-Spoon GOOtensils baby self feeding silicone spoon'),
    category: 'feeding-gear',
  ...
  // Baby Formula
  {
    ...
    affiliateUrl: amazonSearch('Holle Organic Infant Formula Stage 1 European biodynamic'),
  ...
  // NEW: More Prenatal Vitamins
  {
    ...
    affiliateUrl: amazonSearch('New Chapter Perfect Prenatal Multivitamin fermented whole food'),
    category: 'prenatal-vitamins',
  ...
  },
  {
    ...
    affiliateUrl: amazonSearch('Nature Made Prenatal Multi DHA softgel USP verified'),
    category: 'prenatal-vitamins',
  ...
  // NEW: Water Filter (Heavy Metals)
  {
    ...
    affiliateUrl: amazonSearch('Clearly Filtered Water Pitcher removes lead arsenic fluoride contaminants'),
    category: 'testing-kits',
  ...
  // NEW: Organic Toddler Snacks
  {
    ...
    affiliateUrl: amazonSearch('Serenity Kids Organic Toddler Puffs veggie grain no rice low arsenic'),
    category: 'organic-food',
  ...
  },
  {
    ...
    affiliateUrl: amazonSearch('Once Upon a Farm Organic toddler food pouches cold pressed variety'),
    category: 'organic-food',
  ...
  },
  {
    ...
    affiliateUrl: amazonSearch('Sprout Organic toddler meals power pack variety USDA organic'),
    category: 'organic-food',
  ...
  // NEW: BPA-Free Storage Set
  {
    ...
    affiliateUrl: amazonSearch('OXO Tot glass baby food storage containers BPA free stackable'),
    category: 'storage',
  ...
  // NEW: Organic Meal Pouches
  {
    ...
    affiliateUrl: amazonSearch('Amara Organic baby food breastmilk mixing powder single ingredient'),
    category: 'organic-food',
  ...
  // NEW: Lactation Supplement
  {
    ...
    affiliateUrl: amazonSearch('Legendairy Milk Organic lactation supplement fenugreek free'),
    category: 'postnatal-vitamins',
  ...
  // NEW: Postnatal Vitamin
  {
    ...
    affiliateUrl: amazonSearch('Perelel Postpartum Pack postnatal vitamins OB formulated omega-3'),
    category: 'postnatal-vitamins',
